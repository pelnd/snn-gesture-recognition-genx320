...
Weight decay variant of the event-count base run: same config (64 channels,
8 timesteps, batch size 16, 64 epochs, GPU) plus weight_decay=1e-4 on the
Adam optimizer.
...
RUN_NAME = 'count_decaying_weight'
...
def main():
    ...
    optimizer = torch.optim.Adam(params=net.parameters(), lr=LR, weight_decay=1e-4)
