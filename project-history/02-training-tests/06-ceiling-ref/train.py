...
Ceiling reference: a scaled-up version of the time-windowing base run
(05-time-windowing), used to try the best-case accuracy achievable with
this windowing approach. Same 125ms time-based frames and non-overlapping
sliding windows, but a much larger model (128 channels, T=16, batch size 4
to fit memory).
...
DURATION = 125_000
BATCH_SIZE = 4
CHANNELS = 128       # width of the conv layers in the network
EPOCHS = 64
LR = 1e-3
