...
The training and evaluation code in this project is based on SpikingJelly's `classify_dvsg.py` example (https://github.com/fangwei123456/spikingjelly), used and adapted under its license, reproduced below.

SpikingJelly is distributed under the Qizhi (Open-Intelligence) Open Source License 1.0. The Chinese text is the authoritative version, as published in SpikingJelly's own repository.
